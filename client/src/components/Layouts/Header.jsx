    ...
    return (
        <header className='font-[sans-serif] min-h-[60px] tracking-wide relative z-50'>
            ...
            <div className='flex flex-wrap items-center justify-between py-3 px-4 sm:px-10 bg-[#151d20] lg:gap-y-4 gap-y-6 gap-x-4'>
                <Link to={'/'} className="flex items-center gap-3" ><img src="https://i.ibb.co.com/GnvZBW8/logo1-1.png" alt="logo" className='w-12' />
                <h2 className="font-rancho text-3xl text-[#FFFFFF]">Espresso Emporium</h2>
                </Link>
                ...
                <div id="collapseMenu"
                    ...
                    <ul
                        ...
                        <li className='mb-6 hidden max-lg:block'>
                            <Link ><img src="https://readymadeui.com/readymadeui-white.svg" alt="logo"
                                className='w-36' />
                            </Link>
                        </li>
                        <li
                            ...
                            <Link className='text-white block text-[15px] font-medium'>Home</Link>
                        </li>
                        <li
                        ...
                        <li
                            className='max-lg:border-b max-lg:py-3 relative lg:hover:after:absolute lg:after:bg-white lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-[2px] lg:after:block lg:after:-bottom-4 lg:after:transition-all lg:after:duration-300'>
                            <Link to={'/add-coffee'} className='text-white block text-[15px] font-medium'>Add Coffee</Link>
                        </li>
                        <li
                            className='max-lg:border-b max-lg:py-3 relative lg:hover:after:absolute lg:after:bg-white lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-[2px] lg:after:block lg:after:-bottom-4 lg:after:transition-all lg:after:duration-300'>
                            <Link className='text-white block text-[15px] font-medium'>Account</Link>
                        </li>
                        <li
                            className='max-lg:border-b max-lg:py-3 relative lg:hover:after:absolute lg:after:bg-white lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-[2px] lg:after:block lg:after:-bottom-4 lg:after:transition-all lg:after:duration-300'>
                            <Link className='text-white block text-[15px] font-medium'>Contact</Link>
                        </li>
                    </ul>
                </div>
